  ...
  return (
    <section className="mt-6 space-y-4">
      ...
      <div className="text-xs text-zinc-500 mb-2">
        Только официальные турниры (с 18 сезона). В таблице показаны итого и
        значения за матч.
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl border border-zinc-200 p-4">
          <h4 className="font-semibold text-sm mb-3">Атака</h4>
        ...
        {/* Созидание / пасы */}
        <div className="rounded-xl border border-zinc-200 p-4">
          <h4 className="font-semibold text-sm mb-3">Созидание и пасы</h4>
          <dl className="space-y-1 text-sm">
            <Row
        ...
        {/* Дриблинг */}
        <div className="rounded-xl border border-zinc-200 p-4">
          <h4 className="font-semibold text-sm mb-3">Дриблинг</h4>
          <dl className="space-y-1 text-sm">
            <Row
        ...
        {/* Оборона */}
        <div className="rounded-xl border border-zinc-200 p-4">
          <h4 className="font-semibold text-sm mb-3">Оборона</h4>
          <dl className="space-y-1 text-sm">
            <Row
              label="Перехваты"
        ...
        {/* Навесы */}
        <div className="rounded-xl border border-zinc-200 p-4">
          <h4 className="font-semibold text-sm mb-3">Навесы</h4>
          <dl className="space-y-1 text-sm">
            <Row
